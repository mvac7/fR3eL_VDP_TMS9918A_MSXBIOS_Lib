...
void main(void) 
{
	...
	// Copy a 8x8 tile Pattern to VRAM Sprite Pattern Table
	CopyFromVRAM(G1_PAT+16,(unsigned int) TheSprite,8);
...
__asm call 0x009F __endasm;	
	...
	CopyToVRAM((unsigned int) text01,G1_MAP,11);
